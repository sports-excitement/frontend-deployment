(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_lib_e19f3742._.js", {
...
"[project]/src/lib/Redux/auth/authActions.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/Redux/auth/authSlice.ts [app-client] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@reduxjs/toolkit/dist/redux-toolkit.modern.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/Redux/auth/authActions.ts [app-client] (ecmascript)");
;
;
const initialState = {
    idToken: null,
...
const authSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    ...
    extraReducers: (builder)=>{
        builder.addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginAction"].pending, (state)=>{
            state.loading = true;
            state.error = null;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginAction"].fulfilled, (state, action)=>{
            state.loading = false;
            state.idToken = action.payload.idToken;
            state.refreshToken = action.payload.refreshToken;
            state.error = null;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginAction"].rejected, (state, action)=>{
            state.loading = false;
            state.error = action.payload;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["registerAction"].pending, (state)=>{
            state.loading = true;
            state.error = null;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["registerAction"].fulfilled, (state, action)=>{
            state.loading = false;
            state.idToken = action.payload.idToken;
            state.refreshToken = action.payload.refreshToken;
            state.error = null;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["registerAction"].rejected, (state, action)=>{
            state.loading = false;
            state.error = action.payload;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logoutAction"].pending, (state)=>{
            state.loading = true;
            state.error = null;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logoutAction"].fulfilled, (state)=>{
            state.loading = false;
            state.idToken = null;
            state.refreshToken = null;
            state.error = null;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logoutAction"].rejected, (state, action)=>{
            state.loading = false;
            state.error = action.payload;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resetPasswordRequestAction"].pending, (state)=>{
            state.loading = true;
            state.error = null;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resetPasswordRequestAction"].fulfilled, (state)=>{
            state.loading = false;
            state.error = null;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resetPasswordRequestAction"].rejected, (state, action)=>{
            state.loading = false;
            state.error = action.payload;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resetPasswordAction"].pending, (state)=>{
            state.loading = true;
            state.error = null;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resetPasswordAction"].fulfilled, (state, action)=>{
            state.loading = false;
            state.idToken = action.payload.idToken;
            state.refreshToken = action.payload.refreshToken;
            state.error = null;
        }).addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resetPasswordAction"].rejected, (state, action)=>{
            state.loading = false;
            state.error = action.payload;
        });
    }
...
"[project]/src/lib/Redux/auth/authSlice.ts [app-client] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/Redux/auth/authActions.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/lib/Redux/auth/authSlice.ts [app-client] (ecmascript) <locals>");
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@reduxjs/toolkit/dist/redux-toolkit.modern.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/lib/Redux/auth/authSlice.ts [app-client] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/lib/Redux/auth/authSlice.ts [app-client] (ecmascript) <locals>");
...
const store = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["configureStore"])({
    reducer: {
        auth: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$Redux$2f$auth$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"]
    }
});
;
...
//# sourceMappingURL=src_lib_e19f3742._.js.map