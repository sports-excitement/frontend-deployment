      ...
      <div className="container mx-auto max-w-7xl">
        <div className="flex items-center">
          <div className="hero-content">
            ...
            <div className="hero-features mb-4 gap-2">
          ...
          <div className="hero-image relative"><div className="absolute -top-[20%] -right-[20%] w-[140%] h-[140%] bg-gradient-to-br from-[#FFE4E6] to-[#FFF1F2] opacity-70 -z-10 rounded-full" />
